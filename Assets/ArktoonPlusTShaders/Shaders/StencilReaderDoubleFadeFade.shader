...
Shader "arktoon+T/Stencil/Reader/Double/FadeFade" {
    Properties {
        // Transform UV
        ...
        [Enum(Default,0, Channel1,1, Channel2,2)]_MainTexUVSecondary("[CommonSecondary] Base Texture UV", Int) = 0
        _ColorSecondary ("[CommonSecondary] Base Color", Color) = (1,1,1,1)
        _BumpMapSecondary ("[CommonSecondary] Normal map", 2D) = "bump" {}
        [Enum(Default,0, Channel1,1, Channel2,2)]_BumpMapUVSecondary("[CommonSecondary] Normal map UV", Int) = 0
        _BumpScaleSecondary ("[CommonSecondary] Normal scale", Range(0,2)) = 1
        _EmissionMapSecondary ("[CommonSecondary] Emission map", 2D) = "white" {}
        [Enum(Default,0, Channel1,1, Channel2,2)]_EmissionMapUVSecondary("[CommonSecondary] Emission map UV", Int) = 0
        _EmissionColorSecondary ("[CommonSecondary] Emission Color", Color) = (0,0,0,1)
        _Emission2MapSecondary ("[CommonSecondary] Emission2 map", 2D) = "black" {}
        [Enum(Default,0, Channel1,1, Channel2,2)]_Emission2MapUVSecondary("[CommonSecondary] Emission2 map UV", Int) = 0
        _Emission2ColorSecondary ("[CommonSecondary] Emission2 Color", Color) = (0,0,0,1)
        // Alpha Mask
